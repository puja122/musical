...
<div class="jumbotron text-center" id="aboutjumbo">
	<h2> Lets play music with MY MUSIC </h2>
</div>
<div class="container-fluid" >
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4" id="about-block">
			<div id="about-title"><b>About</b></div><br><br>
			MY MUSIC is online Music store where you can listen music online. It provide a simple and attractive User Interface and hence very easy to use. You can play Music from various categories provided by Muzika. This project is developed with love by Pradosh kumar chakra and for more information you can contact me at pradoshchakra10 at gmail dot com. 
		</div>
	</div>
